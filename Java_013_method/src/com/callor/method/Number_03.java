...
public class Number_03 {
	...
	public static void main(String[] args) {
		...
		// 입력된 문자열에 혹시 있을지 모를 whiteSapce를 제거하고
		// 입력문자열이 QUIT인가를 검사하는 코드
		// 객체의 chainning
		if(strInput.trim().equals("QUIT")) {
			...
			/*
			 * 예외처리
			 * Integer.valueOf(문자열) 코드가 실행는 동안
			...
			try {
				...
				// e.printStackTrace();
				System.out.println("숫자가 아닌 값을 임력하였음");
				System.out.println("슷자로 변환하는 동안 오류");
			}
		}
	}
}
