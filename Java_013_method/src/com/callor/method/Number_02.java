...
public class Number_02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 데이터를 단독으로 처리할 때는 큰 문제가 없는데
		 * 	파일에 저장, 파일에서 읽기
		 * 	네트워크(인터넷)등을 통하여 전송(공유) 등으로 
		 * 	데이터가 컴퓨터와 컴퓨터간에 이동할 때
		 ...
		 * 	섞여 있는 경우, NumberFormatException이 
		 * 	발생할 수 있다.
		 */
		intNum1 = Integer.valueOf("100");
	
		intNum1 = Integer.valueOf(30 + ""); // "30" 과 같다
		intNum1 = Integer.valueOf("" + 30); // "30" 과 같다
		...
		intNum1 = Integer.valueOf(" 100");
		intNum1 = Integer.valueOf("100 ");
		intNum1 = Integer.valueOf(100 + " "); //위랑 같은 코드
		...
		// 	취급하지 않는다.
		intNum1 = Integer.valueOf(""); // 혼자만 있으면 오류발생
		intNum1 = Integer.valueOf(null); //둘다 exception발생
