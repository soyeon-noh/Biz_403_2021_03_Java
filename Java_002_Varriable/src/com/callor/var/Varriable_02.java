...
public class Varriable_02 {
	...
	public static void main(String[] args) {
		 ...
		 * 단어를 조합할 경우
		 * 2번째 단어부터는 첫글자를 대문자 또는 
		 * 		단어와 단어 사이를 under bar로 구분
		 * 
		 * intNum1 = Camel case
		 * int_num_1 = snacke case
		 * int_num1
		 * 
		...
		// int, Integer 형보다 가장치 소모 용량이 크다
		// int 형은 최대 2의 32승만큼 공간
		// long형은 최대 2의 64승만큼 공간
		long longNum1 = 0l;
		Long longNum2 = 0L; //뒤에 l 대소문자상관없이 안붙이면 오류
