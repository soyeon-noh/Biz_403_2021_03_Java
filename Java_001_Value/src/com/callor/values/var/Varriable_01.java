...
public class Varriable_01 {
	...
	public static void main(String[] args) {
		 ...
		 *  기억장치를 15개 낭비하게 된다.
		 *  
		 *  30과 40이라는 두 숫자를 어떤 지정된 기억장소에
		 *  보관해두고 연산할 때 그 값을 참조하여 연산을 하도록 한다면
		 *  기억장치를 효율적으로 사용할 수 있을 것이다.
		 *  
		 *  이러한 개념을 발전시킨 것을 "변수(Varriable)"이라고 한다.
		 */
