...
public class Varriable_03 {
	...
	public static void main(String[] args) {
		...
		num1 = 30 % 2;
		System.out.println(num1); // 0이 출력됨
		
		num1 = 30 * 100; // 이 명령문은 위 출력에 아무 영향 x
		
		/*
		 * 선언만 된 변수는 (int num3;) 
		 * 현재 그 기억장소에 어떤 값이 보관되어 있는지 알 수가 없다.
		 * 따라서 그 변수값을 읽어서 처리하는 코드는 오류가 발생한다.
		 * 
		 * 변수는 선언할 때 반드시 어떤 값을 저장해 주는 것이 좋다.
		 * 
		 * 만약 지정될 값이 아직 정해지지 않았다면
		 * 0을 저장하자.
		 */
		...
		// int num3; => 선언(예약)만 한 변수라서 
		// System.out.println(num3); => 보여달라고하면 안보여줌(오류)
