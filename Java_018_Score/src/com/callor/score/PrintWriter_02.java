...
public class PrintWriter_02 {
	 ...
	 * 
	 * 이진수 8개를 특별한 그룹으로 묶어서
	 * 		4Byte, 2Byte, 8Byte 단위로 저장하는데
	 * 		이 단위를 WORD 라고 한다. (..?이해잘 x)
	 * 
	 * 이 데이터를 파일에 저장/읽기를 할 때, 
	 * 		네트웨크를 통해서 데이터를 교환할 때는
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				System.out.println("입력문자열 : " + str);// 콘솔에 보여줌
				out.println("입력값 : " + str); // 파일에 기록
			}
