...
public class AddrEx_01 {//AddressVO
	...
	public static void main(String[] args) {
		...
		//객체의 멤버변수에 값을 저장
		홍길동.name = "홍길동";
		홍길동.cellPhone = "010-1111-1111";
		홍길동.email = "hong@gmail.com";
		홍길동.chain = "친구";
		홍길동.address = "서울특별시"; //아까 AddressVO에서 public 설정안해놨으면 여기서 인식이 안된다.
		
		AddressServiceV1 ssV1 = new AddressServiceV1();
		ssV1.printAddress("홍길동", "hong@gmail.com", "010-1111-1111"); 
		System.out.println("====================================");
		ssV1.printAddress(홍길동); // 홍길동 객체를 통쨰로 가져옴
	}
}
