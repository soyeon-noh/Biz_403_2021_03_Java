...
public class Const_02 {
	...
	public static void main(String[] args) {
		 ...
		 *  구현체 클래스(인터페이스가 있는 클래스)의 생성자를 호출하여
		 *  	객체를 생성, 초기화 해야한다.
		 *  
		 *   인터페이스는 생성자 메서드가 없다. (중요!!)
		 */
	...
	// 똑같은 list method 3개를 만들어야 위의 코드에 오류가 안난다.
	/*
	 * 여기에 있는 세개의 method는 
	 * 각각 ArrayList, LinkedList, Vector type의
	 * 매개변수를 전달받아 연산을 수행한다.
	 * 
	 * 세개의 method는 하는 일이 똑같은 코드이지만
	 * 매개변수 type이 달라서 어쩔 수 없이 
	 * 중복하여 코드가 작성되어야 한다.
	 * (interface를 쓰면 코드가 더 간결해진다!)
	 */
