...
public class NumberEx_01 {
	...
	public static void main(String[] args) {
		...
		//두개의 매겨변수를 갖는 addNum() method에게 
		//정수 31과 29를 전달하고
		// 그 결과를 retNum 변수에 담아라(저장하라)
		...
		Float retNum1 = nsV1.addNum(30.2f, 30.2f);
		
		//NullPointerException 발생
		//float retNum2 = nsV1.addNum(30.2f, 30.2f);
		 ...
		 * 
		 * 특히 숫자를 다루는 경우에
		 * 항상 숫자값만 저장된다는 보장이 있을 경우에는
		 * 		primitive 방식으로 선언해도 아무런 문제가 없다
		 * java나 DB(DataBase)와 연동되는 프로젝트를 구현할 때는
		 * 		null(널) 이라는 특별한 값을 항상 인식해야 한다.
		 * 		어떤 결과가 null 값을 갖게되는 경우
		 * 		primitive 방식에서는 취급이 불가능하다
		 * 
		 *  이럴때는 변수를 선언할 때
		 *  	wrapper class 방식을 사용하는 것이 바람직하다.
		 */
		
		// 객체지향 특징중 < 다형성 >
		//		metohd의 중복선언 이라고도 한다.
		//
