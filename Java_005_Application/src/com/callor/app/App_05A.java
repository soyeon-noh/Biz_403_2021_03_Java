...
/*
 *  5명 학생의 3과 점수(국어, 영어, 수학)의 성적표를 만들기
 */
public class App_05A {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 5; i++) {
			...
			System.out.printf(intEngs[i] + "\t");
			System.out.printf(intMaths[i] + "\t");

			System.out.printf(intTotal[i] + "\t");
			System.out.printf("%3.2f\n", floatAvg[i]);
			
			intKorTotal += intKors[i];
			intEngTotal += intEngs[i];
			intMathTotal += intTotal[i];
