...
public class Hello_03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(5 % 2); //모듈라 연산
		
		System.out.println("==================");
		/* 40을 30으로 나누면 일반적인 수학 연산에서는 소수점 이하 값이 나타나지만
		...
		*/
		...
		// = 소수점이하 16자리까지 표현하고 이후 값은 무시 또는 반올림등을 수행한다.
		// = 오차 발생!
		...
		// 배정도 실수 :
		//			단정소 실수의 2배 이상 자리까지 표현한 실수
		// 고정소수점 연산(값)
		//			정수는 소수점이하 0번재 자리에서 반올림한다.
