...
public class ScannerEx_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 예외가 발생할 것 같은 코드들을
		 * try { } block에 작성하고 실행했을 때
		 * 		만약 exception이 발생한다면
		 * 		catch 명령이 exception을 잠시
		 * 		잡고 있는 상황이 된다.
		 * catch { } block 에 exception이 발생했을 때
		 * 		사용자에게 알려주는 메시지 등을 보여주거나
		 * 		다른 코드를 사용하여 처리할 수 있으면 처리하고
		 * 		코드가 다시 진행되도록 한다.
		 */
		try {
		...
		System.out.println("입력된 숫자는 " + intNum1);
