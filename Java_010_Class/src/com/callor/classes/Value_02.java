...
public class Value_02 {
	...
	public static void main(String[] args) {
		...
		// 값이 num 변수에 저장되고 다음 코드가 실행된다.
		// Integer num = scan.nextInt(); //그냥 엔터누르면 계속해서 입력을 기다림
		// System.out.println(num);
		
		
		// 키보드에서 문자열을 입력하고 Enter를 누르면
		// 값이 str 변수에 저장되고 다음 코드가 실행된다.
		// 그냥 Enter만 눌러도 입력을 종료하고 
		// 다음 코드가 실행된다.
		
		System.out.print("숫자1>> ");
		String str1 = scan.nextLine(); // 그냥 엔터누르면 멈춤.
		if(str1 == "") { // ""은 문자열변수에서 null 값과 유사한 성격을 갖는 값
